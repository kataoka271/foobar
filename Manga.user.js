...
`);
  ...
  class Slides {
    ...
    getGlobalAspect() {
      return document.documentElement.style.getPropertyValue("--manga-image-aspect");
    }
    ...
    goNext(shift) { this.setOffset(this.slideOffset + (shift ? 1 : 2)); }

    goPrev(shift) { this.setOffset(this.slideOffset - (shift ? 1 : 2)); }
